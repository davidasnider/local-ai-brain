...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a preview (first 100 characters) of the last message or prompt. Enabling this may write user-provided content to logs; use with caution.
