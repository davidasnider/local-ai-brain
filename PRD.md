...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a truncated preview (approx. 100 characters) of the *last* message/prompt only (src/local_ai_brain/main.py:134-167). Enabling this may write user-provided content to logs; use with caution.
