...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a preview (first 100 characters) of the last message/prompt only (refer to the prompt preview logic in `src/local_ai_brain/main.py`). Enabling this may write user-provided content to logs; use with caution.
