...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a 100-character preview of the last user message (newlines collapsed). Enabling this may write user-provided content to logs; use with caution.
