...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a 100-character preview of the last user message (newlines and carriage returns collapsed, with an ellipsis appended if truncated). Enabling this may write potentially sensitive user-provided content to logs; use with caution.
