...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a preview of the *last* message/prompt only (refer to the prompt preview logic in `main.py`). Enabling this may write user-provided content to logs; use with caution.
