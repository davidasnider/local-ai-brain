...
* **Observability & Telemetry:**
  ...
  * Set `LOG_PROMPTS=true` in the environment to log a truncated preview of the last user message/prompt. Enabling this may write user-provided content to logs; use with caution.
