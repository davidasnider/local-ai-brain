...
- **`update-deps`**: Updates development dependencies (`llama-cpp-python`) to the latest version and checks for Hugging Face model updates on the models in use (Qwen, Whisper, Kokoro).
